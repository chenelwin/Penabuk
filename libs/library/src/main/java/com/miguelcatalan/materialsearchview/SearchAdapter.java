...
public class SearchAdapter extends BaseAdapter implements Filterable {
    ...
    private boolean checkIfSuggestionContainsQuery;
    ...
    public SearchAdapter(Context context, String[] suggestions, Drawable suggestionIcon, boolean ellipsize, boolean checkIfSuggestionContainsQuery) {
        inflater = LayoutInflater.from(context);
        data = new ArrayList<>();
        this.suggestions = suggestions;
        this.suggestionIcon = suggestionIcon;
        this.ellipsize = ellipsize;
        this.checkIfSuggestionContainsQuery = checkIfSuggestionContainsQuery;
    }
            ...
            protected FilterResults performFiltering(CharSequence constraint) {
                ...
                if (!TextUtils.isEmpty(constraint)) {
                    ...
                    for (String string : suggestions) {
                        if(checkIfSuggestionContainsQuery){
